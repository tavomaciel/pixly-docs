...
![onions](./guides/animation/onions.png)
...
### Interface designed to work on small and large devices
Designed for 4.7" screens and up, the UI is minimalist and cohesive.
